...
class NWBConverter(neuroconv.NWBConverter):
    ...
    data_interface_classes = dict(
        ...
        RecordingNP0=neuroconv.datainterfaces.SpikeGLXRecordingInterface,
        RecordingNP0lfp=neuroconv.datainterfaces.SpikeGLXRecordingInterface,
        SortingNP0=neuroconv.datainterfaces.KiloSortSortingInterface,
