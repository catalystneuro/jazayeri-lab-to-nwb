...
def _add_v_probe_data(raw_source_data,
...
def _add_spikeglx_data(raw_source_data,
                       raw_conversion_options,
                       processed_source_data,
                       processed_conversion_options,
                       session_paths,
    ...
    # Raw data
    spikeglx_dir = [
        x for x in (session_paths.raw_data / 'spikeglx').iterdir()
...
def session_to_nwb(subject: str,
                   session: str,
